...
namespace PXLFunds
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // DB
            services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(Configuration["ConnectionStrings:ApplicationDbContext"]));
            //Identity
            ...
            services.AddScoped<IFundInfoRepository, FundInfoDbRepository>();
